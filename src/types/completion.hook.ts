...
export interface UseCompletionReturn {
  ...
  // Notes popover management
  /** Whether the notes popover is open */
  isNotesPopoverOpen: boolean;
  /** Function to control notes popover visibility */
  setIsNotesPopoverOpen: Dispatch<SetStateAction<boolean>>;
}
